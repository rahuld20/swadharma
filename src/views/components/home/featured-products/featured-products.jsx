...
export default function Products() {
  const { productFilters, products } = useHomeFeed()
  /* Derived, not seeded: against a live API the filters arrive after the
     first render, and a default frozen at mount would stay empty. */
  const [picked, setPicked] = useState(null)
  const filter = picked || productFilters[0]
