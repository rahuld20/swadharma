...
export function AddMoney() {
  const { offerFor, rechargeOffers, walletPacks } = useWalletOptions()
...
export function RechargePayment() {
  const { gstRate, offerFor, upiMethods } = useWalletOptions()
  ...
  const gst = Math.round(amount * gstRate)
