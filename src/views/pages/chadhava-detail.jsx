...
import { ChadhavaCard } from '@/views/components/chadhava'
...
export default function ChadhavaDetail({ slug }) {
  const { benefits, chadhavas, chadhavasOf, combos, faqs, getChadhava, getTemple, isSpecialChadhava, loading, nextChadhavaCutoff, sacredProcess } = useChadhavaCatalog()
