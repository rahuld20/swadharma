...
import {
  FLAT_OFFER, PRODUCTS, PRODUCT_FAQS, PRODUCT_REVIEWS, SHIPPING,
  getProduct, offerDeadline,
      ...
      <div className="wrap pd-wrap">
        <div className="pd-main">
          ...
          <div className="review-list">
            {[...posted, ...PRODUCT_REVIEWS].map((r, i) => (
        ...
        <aside className="pd-buy">
          ...
          <div className="flat-offer">
            <div className="fo-top">
              <strong>{FLAT_OFFER.label}</strong>
              <small>{FLAT_OFFER.sub} · code <b>{FLAT_OFFER.code}</b></small>
            </div>
